...
import tisawem.gametesting.vol1.midi.InstrumentStandard.Companion.PERCUSSION_CHANNEL
...
//Standard Kit
  ...
  private  fun getMSBControlChangeEvent (      value:Byte)= ControlChangeEvent(tick,channel,MSB_CONTROLLER,value)
  private  fun getLSBControlChangeEvent (       value:Byte)= ControlChangeEvent(tick,channel,LSB_CONTROLLER,value)
   private fun getProgramEvent(program: Byte)= ProgramEvent(tick,channel,program)
