...
package tisawem.gametesting.vol1.lwjgl3.i18n
...
object Messages {
    ...
    private fun ensureBundle() {
        ...
        val configLanguage = CoreConfig.Language.load().ifEmpty { ULocale.getDefault().language }
...
1、MissingResourceException
    a.  ${DesktopConfig.LanguageResourcePath.load()}
